...
@echo Adding tables
dab add "Solicitude" --source "[dbo].[Solicitudes]" --fields.include "numero,fecha,solicita,estado,detalle,tipoCambio" --permissions "anonymous:*" 
dab add "TipoCambio" --source "[dbo].[TipoCambio]" --fields.include "id,nombre" --permissions "anonymous:*" 
@echo Adding views and tables without primary key
@echo Adding relationships
dab update Solicitude --relationship TipoCambio --target.entity TipoCambio --cardinality one
dab update TipoCambio --relationship Solicitude --target.entity Solicitude --cardinality many
